                                                    ...
                                                    <tr style="">
                                                        <td class="body-padding mobile-padding"
                                                            ...
                                                            <table class="soapbox"
                                                                ...
                                                                <tbody>
                                                                    <tr style="height: 10px;">
                                                                        <td class="body-text-cell" align="left">
                                                                           <p  style="margin: 0px 0px 16px 0px padding:0;font-family: 'Nexa'; font-style: normal; font-weight: 700; font-size: 16px; line-height: 24px; color: #135F84;">
                                                                        ...
                                                                        <td class="body-padded" style="padding:0;">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell" style="">
                                                                                            <p style="margin: 0px 0px 16px 0px ;0;padding:0;font-family: 'Nexa'; font-style: normal; font-weight: 400; font-size: 16px; line-height: 24px; color: #135F84;">
                                                                            ...
                                                                            <table class="body-text"style="" align="">
                                                                                <tbody>
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell" style="">
                                                                                            <p style="margin: 32px 0px 0px 0px ;padding:0;font-family: 'Ubuntu';font-style: normal;font-weight: 400;font-size: 12px;line-height: 20px;color: #135F84;">
                                                                                                ...
                                                                                                <br>
                                                                                                <p style="margin: 0px 0px 40px 0px ;font-family: 'Ubuntu'; font-style: normal; font-weight: 400; font-size: 12px; line-height: 20px; color: #1DA9CC;">
                                                                                                    {{ $url }}
                                                                                                </p>
                                                                                            </p>
                                                                                        </td>
                                                                            ...
                                                                            <table class="body-text"style="" align="">
                                                                                <tbody>
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell" style="">
                                                                                            <p style="margin: 0px 0px 16px 0px ;margin:0;padding:0;font-family: 'Nexa';font-style: normal; font-weight: 700; font-size: 16px; line-height: 24px;color: #063F5F;">
                                                                                                Freundliche Grüsse,
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>

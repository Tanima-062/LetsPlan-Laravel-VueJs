                                                        ...
                                                        <td class="body-padding mobile-padding"
                                                            ...
                                                            <table class="soapbox"
                                                                ...
                                                                <tbody>
                                                                    <tr style="height: 10px;">
                                                                        <td class="soapbox-title" style="margin:0;padding:0;font-family: 'Nexa'; font-style: normal; font-weight: 700; font-size: 16px; line-height: 24px; display: flex;align-items: center;color:#135F84;">
                                                                            <p  style="margin:0px 0px 14px 0px; padding:0;font-family: 'Nexa'; font-style: normal; font-weight: 700; font-size: 16px; line-height: 24px; color: #135F84;">
                                                                        ...
                                                                        <td class="body-padded" style="padding:0;">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell" style="">
                                                                                            @php
                                                                                                $company =  \App\Models\User::adminNamebyCompany($user->company_id);
                                                                                                $role =  \App\Models\User::getUserByRole($user->role_id);
                                                                                            @endphp
                                                                                            <p style="margin: 0px 0px 16px 0px; padding:0;font-family: 'Nexa'; font-style: normal; font-weight: 400; font-size: 16px; line-height: 24px; color: #135F84;">
                                                                                                Sie wurden von {{ $company }} eingeladen Lets Plan als {{ $role }} zu nutzen. Bitte melden Sie sich mit Ihrer E-Mail Adresse und folgendem temporären Passwort an:
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            ...
                                                                            <table class="body-text"style="" align="">
                                                                                <tbody>
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell" style="">
                                                                                            <p style="margin: 0px 0px 32px 0px; padding:0;font-family: 'Nexa'; font-style: normal; font-weight: 700; font-size: 16px; line-height: 24px; color: #E97D32;;">
                                                                                                {{ $password }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell" style="text-align: center;width: 100%">
                                                                                            <a href="{{ $url }}" style="border-width: 15px 160px 15px 160px; border-color: #E97D32; border-style: solid; text-decoration: none;  width:100%; text-align: center;  background: #E97D32; padding:0;font-family: 'Nexa'; font-style: normal;font-weight: 700;font-size: 18px;line-height: 27px;color: #FFFFFF;
                                                                                            ">Anmelden</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            ...
                                                                            <table class="body-text"  align="">
                                                                                <tbody>
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell" style="">
                                                                                            <p style="margin: 32px 0px 0px 0px;padding:0;font-family: 'Ubuntu';font-style: normal;font-weight: 400;font-size: 12px;line-height: 20px;color: #135F84;">Sollte der Button nicht ersichtlich sein oder nicht funktionieren, können Sie den folgenden Link komplett kopieren und in Ihrem Internet Browser einfügen und öffnen:
                                                                                                <br>
                                                                                            </p>
                                                                                            <p style="margin: 0px 0px 40px 0px ;padding:0;font-family: 'Ubuntu'; font-style: normal; font-weight: 400; font-size: 12px; line-height: 20px; color: #1DA9CC;">
                                                                                                {{ $url }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>

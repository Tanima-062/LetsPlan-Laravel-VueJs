                                                                                    ...
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell" style="">
                                                                                            ...
                                                                                            <p style="margin:0;padding:0;font-family: 'Nexa'; font-style: normal; font-weight: 400; font-size: 16px; line-height: 24px; color: #135F84;">
                                                                                                Sie wurden von {{$invitedBy->first_name}} {{$invitedBy->last_name}} eingeladen Lets Plan als {{$role}} nutzen zu können.
                                                                                                Bitte melden Sie sich mit Ihrer E-Mail Adresse und folgendem temporären Passwort an:
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell" style="">
                                                                                            ...
                                                                                            <p style="margin:0;padding:0;font-family: 'Ubuntu'; font-style: normal; font-weight: 400; font-size: 12px; line-height: 20px; color: #1DA9CC;">
                                                                                                {{ $url }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>

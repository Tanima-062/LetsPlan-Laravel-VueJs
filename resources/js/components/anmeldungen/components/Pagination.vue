<template>
    <div class="pagination__content">
        <ul class="pagination__body" v-if="show">
            ...
            <li :class="{ disabled: !prev }" class="pagination-item">
                <a @click.prevent="goToPage(pagination.current_page - 1)" class="pagination-link" href="#">
                        ...
                        >
                            <path
                                d="M11.333 2.66699L2.99967 11.0003L11.333 19.3337"
                                stroke="#063F5F"
                                stroke-width="3"
            ...
            <li v-for="(link, index) in links" :key="index" :class="{
                ...
                <a @click.prevent="goToPage(1)" class="pagination-link" :rel="getRelation(link)" href="#" v-if="link == 1">
                        {{ link }}
                    </a>
                <a @click.prevent="goToPage(link)" class="pagination-link" :rel="getRelation(link)" :href="`?page=${link}`" v-else>
                        {{ link }}
                    </a>
            </li>
            ...
            <li :class="{ disabled: !next }" class="pagination-item">
                <a href="#" @click.prevent="goToPage(next)" class="pagination-link">
                        ...
                        >
                            <path
                                d="M2.66699 19.3335L11.0003 11.0002L2.66699 2.66683"
                                stroke="#063F5F"
                                stroke-width="3"
                                stroke-linecap="square"
                            />
        ...
        <div class="alert alert-danger card-m-5" v-if="pagination.total < 1 || pagination.from == null">

    ...
    methods: {
        back() {
            if (this.$attrs.showModal) {
                ...
                const description = "Wenn Sie zurückgehen oder abbrechen, ohne zu speichern, werden alle Änderungen verworfen. Sind Sie sicher, dass Sie die Änderungen wirklich verwerfen wollen?"

<template>
    <div :class="$attrs.class">
        <label v-if="label.length > 0" class="form-label block mb-[8px]" :class="this.$attrs.labelClass" :for="id" v-html="label"></label>
        <div class="relative">
        ...
        "
            ...
            ref="input"
            v-bind="{ ...$attrs }"
            class="lets_plan_input text-gray-3"
...
input.lets_plan_input::placeholder {
    color: #87B1CB;
    opacity: 1;
}

input.lets_plan_input::-webkit-outer-spin-button,
input.lets_plan_input::-webkit-inner-spin-button {
    appearance: none;
}
